...
export const missions = [
  { id:'l1-01', mode:'listening', level:1, title:'To the bookstore', startNodeId:'n22', startFacing:'east', destinationNodeId:'bookstore-front', steps:[step('Go straight.','move','straight')] },
  { id:'l1-02', mode:'listening', level:1, title:'To the post office', startNodeId:'n22', startFacing:'east', destinationNodeId:'n21', steps:[step('Turn left.','turn','left'),step('Go straight.','move','straight')] },
  { id:'l1-03', mode:'listening', level:1, title:'To the department store', startNodeId:'n22', startFacing:'east', destinationNodeId:'department-store-front', steps:[step('Turn right.','turn','right'),step('Go straight.','move','straight')] },
  ...
  { id:'l2-01', mode:'listening', level:2, title:'To the bookstore', startNodeId:'n21', startFacing:'east', destinationNodeId:'bookstore-front', steps:[step('Turn right at the traffic light.','turn','right',{landmarkType:'trafficLight'}),step('Go straight.','move','straight'),step('Turn left.','turn','left'),step('Go straight to the bookstore.','move','straight')] },
  ...
  { id:'l4-01', mode:'listening', level:4, title:'To the bookstore', startNodeId:'n11', startFacing:'east', destinationNodeId:'bookstore-front', steps:[step('Go straight.','move','straight'),step('Turn right at the traffic light.','turn','right',{landmarkType:'trafficLight'}),step('Go straight.','move','straight'),step('Turn left.','turn','left'),step('Go straight to the bookstore.','move','straight')] },
  ...
  { id:'l5-02', mode:'listening', level:5, title:'To the department store', startNodeId:'n30', startFacing:'south', destinationNodeId:'department-store-front', steps:[step('Go straight for two blocks.','move','straight',{distance:2}),step('Turn right at the traffic light.','turn','right',{landmarkType:'trafficLight'}),step('Go straight for two blocks.','move','straight',{distance:2}),step('Turn left.','turn','left'),step('Go straight to the department store.','move','straight')] },
