...
export const missions = [
  ...
  { id:'l2-01', mode:'listening', level:2, title:'To the bookstore', startNodeId:'n21', startFacing:'east', destinationNodeId:'n22', steps:[step('Turn right at the traffic light.','turn','right',{landmarkType:'trafficLight'}),step('Go straight.','move','straight')] },
  { id:'l2-02', mode:'listening', level:2, title:'To the fire station', startNodeId:'n02', startFacing:'east', destinationNodeId:'n03', steps:[step('Turn right at the bus stop.','turn','right',{landmarkType:'busStop'}),step('Go straight.','move','straight')] },
  { id:'l2-03', mode:'listening', level:2, title:'To the park', startNodeId:'n10', startFacing:'south', destinationNodeId:'n20', steps:[step('Turn left at the traffic light.','turn','left',{landmarkType:'trafficLight'}),step('Go straight.','move','straight')] },
  ...
  { id:'l4-01', mode:'listening', level:4, title:'To the bookstore', startNodeId:'n11', startFacing:'east', destinationNodeId:'n22', steps:[step('Go straight.','move','straight'),step('Turn right at the traffic light.','turn','right',{landmarkType:'trafficLight'}),step('Go straight.','move','straight')] },
  { id:'l4-02', mode:'listening', level:4, title:'To the fire station', startNodeId:'n12', startFacing:'west', destinationNodeId:'n03', steps:[step('Go straight.','move','straight'),step('Turn left at the bus stop.','turn','left',{landmarkType:'busStop'}),step('Go straight.','move','straight')] },
  { id:'l4-03', mode:'listening', level:4, title:'To the restaurant', startNodeId:'n23', startFacing:'west', destinationNodeId:'n12', steps:[step('Go straight.','move','straight'),step('Turn right at the bus stop.','turn','right',{landmarkType:'busStop'}),step('Go straight.','move','straight')] },
